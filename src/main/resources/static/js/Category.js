...
function tableRespuestaCat(items) {
    let myTableCat = `<table BORDER CELLPADDING=2 BORDERCOLOR='#193C61'><th scope='col'> CATEGORY </th><th> DESCRIPTION </th><th> BOAT </th>`;
    for (let i = 0; i < items.length; i++) {
        ...
        myTableCat += `<td> <button class="btn-select" value="${items[i].id}" style="background-color:#364B61; border-color:#193C61; color:white;">Change</button></td>`;
        myTableCat += `<td> <button class="btn-delete" value="${items[i].id}" style="background-color:#364B61; border-color:#193C61; color:white;">Delete</button></td>`;
        myTableCat += `</tr>`;
    }
